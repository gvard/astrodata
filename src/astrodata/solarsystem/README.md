...
![Distribution of minor planets by delta-v in semimajor axis range between 0.6 and 2.9](../../../plots/solarsystem/mpcprb-deltav-a0.6-2.9-ru.png "Distribution of minor planets by delta-v in semimajor axis range between 0.6 and 2.9 with marked spacecraft targets")
![Distribution of minor planets by travel (transit) time in semimajor axis range between 0.6 and 2.9](../../../plots/solarsystem/mpcprb-tt-a0.6-2.9-ru.png "Distribution of minor planets by travel (transit) time in semimajor axis range between 0.6 and 2.9 with marked spacecraft targets")  
