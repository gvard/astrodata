...
![Распределение крупнейших нумерованных транснептуновых объектов по характеристической скорости орбитального маневра (Δv)](../../../plots/solarsystem/tno-a-deltav-numbered-ru.png "Распределение крупнейших нумерованных транснептуновых объектов по большой полуоси и характеристической скорости орбитального маневра (Δv)")
...
![Распределение малых планет по характеристической скорости орбитального маневра (Δv) в диапазоне значений большой полуоси между 0.6 и 2.9 а.е.](../../../plots/solarsystem/mpcprb-deltav-a0.6-2.9-ru.png "Распределение малых планет по характеристической скорости орбитального маневра (Δv) в диапазоне значений большой полуоси между 0.6 и 2.9 а.е. с отмеченными целями АМС")
![Распределение малых планет по времени перелета в диапазоне значений большой полуоси между 0.6 и 2.9 а.е.](../../../plots/solarsystem/mpcprb-tt-a0.6-2.9-ru.png "Распределение малых планет по времени перелета в диапазоне значений большой полуоси между 0.6 и 2.9 а.е. с отмеченными целями АМС")  
